...
'''
Monte Carlo tree search (MCTS) for traveling salesman problem (TSP)
Inspired by github : https://github.com/Boyu1997/mcts-travel-salesman
This file implemented the MCTS process that solves a random sample of TSP.
'''
...
class MCTS():
    ...
    def calculate_path_edges(self, path):
        ...
        path_edges.append(tuple([path_edges[-1][1], path_edges[0][0],
                                 self.graph.edges[path_edges[-1][1], path_edges[0][0]]]))
        cost += path_edges[-1][2]['weight']
...
### random MCTS with simulation function ###
...
### greedy MCTS with simulation function ###
